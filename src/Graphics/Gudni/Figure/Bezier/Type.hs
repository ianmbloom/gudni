...
isKnob :: (Axis axis, Space s) => axis -> Bezier s -> Bool
isKnob = isKnobThreshold iota

isKnobAbsolute :: (Axis axis, Space s) => axis -> Bezier s -> Bool
isKnobAbsolute = isKnobThreshold 0

isKnobThreshold :: (Axis axis, Space s) => s -> axis -> Bezier s -> Bool
isKnobThreshold threshold axis bz@(Bez v0 control v1) =
